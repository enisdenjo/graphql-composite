export const supergraph = /* GraphQL */ `
  ...
  enum join__Graph {
    A
      @join__graph(
        name: "a"
        url: "https://federation-compatibility.the-guild.dev/fed2-external-extends/a"
      )
    B
      @join__graph(
        name: "b"
        url: "https://federation-compatibility.the-guild.dev/fed2-external-extends/b"
      )
  }
